...
const ArticleReport = ({ navigation, route }: ArticleReportScreenProps) => {
      ...
      headerRight: () => (
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            Alert.alert("해당 게시글을 신고하시겠습니까?", undefined, [
              {
                text: "취소",
                onPress: () => {
                  return;
              ...
              },
              {
                ...
                onPress: () => {
                  reportArticle({
                    fetchOptions: {
                      data: {
                        targetId: route.params.articleId,
                        targetType: "article",
                        message: content,
